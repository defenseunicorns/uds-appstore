...
<aside
	id="main-sidebar"
	class="fixed left-0 top-14 z-40 h-screen -translate-x-full transition-all duration-300 ease-in-out hover:w-64 sm:translate-x-0 {$isSidebarExpanded
		? 'w-64'
		: 'w-16'}"
>
	<div
		class="flex h-full flex-col overflow-y-auto border-r border-gray-200 bg-white px-3 py-5 dark:border-gray-700 dark:bg-gray-800"
	>
