...
<!--            href="#"-->
<!--            class="text-primary-600 dark:text-primary-500 hover:underline">get started</a-->
...
<!--        </p>-->
<!--        <p class="text-gray-500 dark:text-gray-400">-->
<!--          Check out the <a href="#" class="text-primary-600 dark:text-primary-500 hover:underline"-->
