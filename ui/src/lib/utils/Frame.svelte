...
This code comes from flowbite-svelte - disabling some eslint checks to not modify upstream typing
-->
...
<script lang="ts">
  ...
  interface $$Props extends HTMLAnchorAttributes {
    ...
    use?: Action<HTMLElement, any>; // eslint-disable-line  @typescript-eslint/no-explicit-any
    options?: object;
    class?: string;
    role?: string;
    open?: boolean;
  ...
  export let use: Action<HTMLElement, any> = noop; // eslint-disable-line  @typescript-eslint/no-explicit-any
  export let options = {};
