...
<section class=" flex w-full justify-center bg-white dark:bg-gray-900">
  <div class=" mx-auto px-4 py-8 lg:px-6 lg:py-16">
    <div class="mx-auto max-w-screen-sm text-center">
      <h1
        class="mb-4 text-7xl font-extrabold tracking-tight text-gray-900 dark:text-white lg:text-9xl"
      >
        404
      </h1>
