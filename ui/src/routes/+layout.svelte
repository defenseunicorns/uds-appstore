...
<main
	class="flex h-screen flex-col px-24 py-9 transition-all duration-300 ease-in-out dark:bg-gray-900 dark:text-white"
>
	<div class="flex-grow overflow-hidden py-9">
		<slot />
	</div>
</main>
